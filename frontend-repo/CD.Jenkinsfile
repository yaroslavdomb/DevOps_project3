...
'''
    ...
    parameters {
        string(name: 'TAG', defaultValue: '', description: 'Build number produced by build-frontend')
    }
                                ...
                                def created = sh(
                                    script: '''
                                        curl -s -X POST \
                                          ...
                                          -d "{\\"title\\":\\"CD: frontend code DEV -> MAIN\\",\\"head\\":\\"DEV\\",\\"base\\":\\"main\\",\\"body\\":\\"Automated code merge, triggered by build ${TAG}\\"}" \
                                          | jq -r '.number'
                                    ''',
                                    returnStdout: true
                                ).trim()
